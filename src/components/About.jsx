...
const About = props => {
    ...
    const ScrollingText = styled.div`
            ...
            color: #fff;
            font-size: ${xs ? "1.5rem" : sm || md || lg ? "2rem" : xl ? "3rem" : "4.5rem"};
            line-height: 1.25;
            background-color: #4E334E;
            grid-template-columns: repeat(12, 1fr);
            display: grid;
            grid-template-areas: ${xs | sm || md || lg ?
            `
        ...
        .heading {
            font-size: ${xs ? "1.75rem" : sm || md || lg ? "2.5rem" : xl ? "3.5rem" : "5rem"}; 
            font-weight: 700;
            padding-bottom: .5em;
        }
        .skills {
        ...
        .live {
            font-size: ${xs ? "1.5rem" : sm || md || lg ? "2rem" : xl ? "2.75rem" : "4.25rem"};
        }
        .thanks {
            position: relative;
            z-index: 1;
