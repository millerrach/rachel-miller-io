...
const StyledSVG = styled.svg`
    ...
    width: ${props => props.hover && !props.touchscreen ? props.width + 5 : props.width};
    `;
...
const Email = props => {
    ...
    return (
        ...
        >
            <StyledSVG {...props} hover={hover} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
